  ...
  <layout :layout-data="layoutData">
    ...
    <main class="relative sm:mt-20">
      <div class="mx-auto max-w-3xl px-2 py-2 sm:py-6 sm:px-6 lg:px-8">
        ...
        <ul v-if="localCallReasonTypes.length > 0" class="mb-6 rounded-lg border border-gray-200 bg-white">
        ...
        <!-- blank state -->
        <div v-if="localCallReasonTypes.length == 0" class="mb-6 rounded-lg border border-gray-200 bg-white">
