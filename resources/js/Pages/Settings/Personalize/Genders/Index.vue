      ...
      <div class="mx-auto max-w-3xl px-2 py-2 sm:px-6 sm:py-6 lg:px-8">
        ...
        <form
          ...
          <div class="flex justify-between p-5">
            <pretty-span :text="$t('Cancel')" :classes="'ltr:mr-3 rtl:ml-3'" @click="createGenderModalShown = false" />
        ...
        <ul
          ...
          <li
            ...
            <div v-if="renameGenderModalShownId != gender.id" class="flex items-center justify-between px-5 py-2">
              ...
              <!-- actions -->
              <ul class="text-sm">
                <li class="inline cursor-pointer ltr:mr-4 rtl:ml-4" @click="updateGenderModal(gender)">
