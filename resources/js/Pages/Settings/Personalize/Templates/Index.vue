      ...
      <div class="mx-auto max-w-3xl px-2 py-2 sm:px-6 sm:py-6 lg:px-8">
        ...
        <form
          ...
          <div class="flex justify-between p-5">
            <pretty-span :text="$t('Cancel')" :classes="'me-3'" @click="createTemplateModalShown = false" />
        ...
        <ul
          ...
          <li
            ...
            <form
              ...
              <div class="flex justify-between p-5">
                <pretty-span :text="$t('Cancel')" :classes="'me-3'" @click.prevent="renameTemplateModalShownId = 0" />
