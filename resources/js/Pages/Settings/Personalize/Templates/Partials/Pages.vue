<template>
  <div>
    ...
    <div
      ...
      class="mb-2 flex items-center rounded-lg border border-gray-200 bg-white px-5 py-2 hover:bg-slate-50 dark:border-gray-700 dark:bg-gray-900 dark:bg-slate-900 hover:dark:bg-slate-800"
    ...
    <draggable
      ...
      <template #item="{ element }">
        <div
          ...
          class="mb-2 flex items-center rounded-lg border border-gray-200 bg-white py-2 pl-2 pr-5 hover:bg-slate-50 dark:border-gray-700 dark:bg-gray-900 dark:bg-slate-900 hover:dark:bg-slate-800"
        ...
        <form
          v-else
          class="item-list mb-2 rounded-lg border border-gray-200 bg-white hover:bg-slate-50 dark:border-gray-700 dark:bg-gray-900 dark:bg-slate-900 hover:dark:bg-slate-800"
    ...
    <form
      ...
      <div class="flex justify-between p-5">
        <pretty-span
          :text="$t('app.cancel')"
          :classes="'mr-3 dark:text-gray-900'"
          @click="createPageModalShown = false" />
        <pretty-button
          :text="$t('app.add')"
          :state="loadingState"
          :icon="'plus'"
