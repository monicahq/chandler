<template>
  <div>
    ...
    <ul
      ...
      <li
        class="item-list border-b border-gray-200 bg-slate-50 py-2 pl-2 pr-5 text-sm dark:border-gray-700 dark:border-gray-800 dark:bg-slate-900 dark:bg-slate-900">
