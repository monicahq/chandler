      ...
      <div class="mx-auto max-w-3xl px-2 py-2 sm:px-6 sm:py-6 lg:px-8">
        ...
        <form
          ...
          <div class="flex justify-between p-5">
            <pretty-span :text="$t('Cancel')" :classes="'me-3'" @click="createGroupTypeModalShown = false" />
          ...
          <draggable
            ...
            <template #item="{ element }">
                ...
                <div
                  ...
                  <div class="ms-8">
                    ...
                    <draggable
                      ...
                      <template #item="{ element, id }">
                        ...
                        <form
                          ...
                          <div class="flex justify-between p-5">
                            <pretty-span :text="$t('Cancel')" :classes="'me-3'" @click="roleGroupTypeId = 0" />
                            <pretty-button
                              :text="$t('Rename')"
                              :state="loadingState"
                              :icon="'check'"
                    ...
                    <form
                      ...
                      <div class="flex justify-between p-5">
                        <pretty-span :text="$t('Cancel')" :classes="'me-3'" @click="createRoleModalShown = false" />
                        <pretty-button
                          :text="$t('Save')"
                          :state="loadingState"
                          :icon="'plus'"
              ...
              <form
                ...
                <div class="flex justify-between p-5">
                  <pretty-span :text="$t('Cancel')" :classes="'me-3'" @click.prevent="editGroupTypeId = 0" />
                  <pretty-button
                    :text="$t('Rename')"
                    :state="loadingState"
                    :icon="'check'"
