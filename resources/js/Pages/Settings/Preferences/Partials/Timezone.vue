...
<template>
  <div class="mb-16">
    ...
    <div class="mb-3 mt-8 items-center justify-between sm:mt-0 sm:flex">
      <h3 class="mb-4 sm:mb-0"><span class="mr-1">🗓</span> Timezone</h3>
    ...
    <div class="mb-6 flex rounded border bg-slate-50 px-3 py-2 text-sm">
      ...
      <div>
        <p>Regardless of where you are located in the world, have dates displayed in your own timezone.</p>
      </div>
    </div>
    ...
    <div v-if="!editMode" class="mb-6 rounded-lg border border-gray-200 bg-white">
      <p class="px-5 py-2">
        <span class="mb-2 block">Current timezone:</span>
    ...
    <form v-if="editMode" class="mb-6 rounded-lg border border-gray-200 bg-white" @submit.prevent="submit()">
      <div class="border-b border-gray-200 px-5 py-2">
        ...
        <select name="timezone" v-model="form.timezone" class="py-2 px-3 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 bg-white rounded-md shadow-sm focus:outline-none sm:text-sm">
