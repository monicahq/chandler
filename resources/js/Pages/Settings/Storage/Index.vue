    ...
    <nav class="bg-white dark:bg-gray-900 sm:border-b">
      <div class="max-w-8xl mx-auto hidden px-4 py-2 sm:px-6 md:block">
        <div class="flex items-baseline justify-between space-x-6">
          <ul class="text-sm">
            <li class="ltr:mr-2 rtl:ml-2 inline text-gray-600 dark:text-gray-400">
              {{ $t('You are here:') }}
            </li>
            <li class="ltr:mr-2 rtl:ml-2 inline">
              <inertia-link
            ...
            <li class="relative ltr:mr-2 rtl:ml-2 inline">
              <svg
    ...
    <main class="relative sm:mt-24">
      <div class="mx-auto max-w-3xl px-2 py-2 sm:py-6 sm:px-6 lg:px-8">
        ...
        <div class="border border-gray-200 dark:border-gray-700 rounded-lg grid grid-cols-2 mb-8">
          <!-- account limit -->
          <div class="flex justify-between p-3 ltr:border-r rtl:border-l border-gray-200 dark:border-gray-700">
        ...
        <!-- detail breakdown -->
        <p class="mb-2">
          <span class="ltr:mr-1 rtl:ml-1">🔽</span> {{ $t('Breakdown of the current usage') }}
        </p>
