              ...
              <div class="mb-8 inline-flex rounded-md shadow-sm">
                ...
                <button
                  ...
                  <svg
                    ...
                    stroke-width="1.5"
                    stroke="currentColor"
                    class="h-4 w-4 fill-current ltr:mr-2 rtl:ml-2">
                    <path
                ...
                <button
                  ...
                  class="inline-flex items-center border-b border-t border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-700 ltr:rounded-r-lg ltr:border-r rtl:rounded-l-lg rtl:border-l dark:border-gray-600 dark:bg-gray-700 dark:text-white hover:dark:bg-gray-600 hover:dark:text-white dark:focus:text-white dark:focus:ring-blue-500">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
