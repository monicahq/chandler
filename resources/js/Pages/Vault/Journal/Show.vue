        ...
        <div class="flex justify-center">
          <div class="mb-8 inline-flex rounded-md shadow-sm">
            ...
            <inertia-link
              ...
              class="inline-flex items-center border-b border-t border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-700 ltr:rounded-r-md ltr:border-r rtl:rounded-l-md rtl:border-l dark:border-gray-600 dark:bg-gray-700 dark:text-white hover:dark:bg-gray-600 hover:dark:text-white dark:focus:text-white dark:focus:ring-blue-500">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
        ...
        <div class="special-grid grid grid-cols-1 gap-6 sm:grid-cols-3">
          ...
          <div class="p-3 sm:p-0">
            ...
            <p v-if="data.years.length > 0" class="mb-2 font-medium">
              <span class="ltr:mr-1 rtl:ml-1"> 📆 </span> {{ $t('Years') }}
            </p>
            ...
            <p v-if="data.tags.length > 0" class="mb-2 font-medium">
              <span class="ltr:mr-1 rtl:ml-1"> ⚡ </span> {{ $t('All tags') }}
            </p>
                ...
                <div v-if="month.posts.length > 0">
                  ...
                  <ul class="border-b border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
                    <li
                      ...
                      <!-- written at -->
                      <div class="rounded-lg border border-gray-200 p-2 text-center leading-tight ltr:mr-4 rtl:ml-4">
          ...
          <div class="p-3 sm:p-0">
            ...
            <!-- slices of life -->
            <p class="mb-2 font-medium"><span class="ltr:mr-1 rtl:ml-1"> 🍕 </span> {{ $t('Slices of life') }}</p>
            <div v-if="data.slices.length > 0" class="mb-2">
              <div v-for="slice in data.slices" :key="slice.id" class="mb-6 last:mb-0">
                ...
                <div
                  class="rounded-b border-b border-gray-200 px-3 py-2 hover:bg-slate-50 ltr:border-l ltr:border-r rtl:border-l rtl:border-r dark:border-gray-700 dark:bg-slate-900 hover:dark:bg-slate-800"
