                ...
                <div class="">
                  ...
                  <div v-if="showContactName" class="pl-6">
                    ...
                    <div class="mb-4 flex flex-wrap text-xs">
                      <span
                        v-if="!showLastNameField"
                        class="mr-2 mb-2 flex cursor-pointer flex-wrap rounded-lg border bg-slate-200 px-1 py-1 hover:bg-slate-300 dark:text-gray-900 dark:bg-slate-500 dark:text-white"
