    ...
    <main class="sm:mt-18 relative">
      <div class="mx-auto max-w-xl px-2 py-2 sm:px-6 sm:py-6 lg:px-8">
        <div class="special-grid grid grid-cols-1 gap-6 sm:grid-cols-3">
          <!-- left -->
          <div>
            <p class="mb-2 font-semibold"><span class="ltr:mr-1 rtl:ml-1">🌍</span> {{ $t('All the countries') }}</p>
          ...
          <div class="p-3 sm:px-3 sm:py-0">
            <p class="mb-2 font-semibold"><span class="ltr:mr-1 rtl:ml-1">🏙️</span> {{ $t('All the cities') }}</p>
