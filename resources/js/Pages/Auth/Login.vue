...
<template>
  <div class="flex min-h-screen flex-col items-center bg-gray-100 pt-6 sm:justify-center sm:pt-0">
    <div>
      <inertia-link href="/">
        <svg class="h-20 w-20 fill-current text-gray-500" viewBox="0 0 390 353" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flex mt-6 w-full overflow-hidden bg-white shadow-md sm:max-w-4xl sm:rounded-lg">
      <img :src="this.wallpaperUrl" class="sm:invisible md:visible w-10/12" />
      <div class="px-6 py-14 w-full">

        <h1 class="text-xl mb-6 text-center"><span class="mr-2">👋</span> Hi friend</h1>
