    ...
    <div
      ...
      <div v-if="canLogin" class="fixed top-0 right-0 hidden px-6 py-4 sm:block">
        <inertia-link
          ...
          class="text-sm text-gray-700 underline dark:text-gray-300">
          Dashboard
        </inertia-link>

        <template v-else>
          <inertia-link :href="route('login')" class="text-sm text-gray-700 underline dark:text-gray-300">
            Log in
          </inertia-link>
          ...
          <inertia-link
            v-if="canRegister"
            :href="route('register')"
            class="ml-4 text-sm text-gray-700 underline dark:text-gray-300">
            Register
          </inertia-link>
        </template>
      </div>
      ...
      <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
        ...
        <div class="mt-8 overflow-hidden bg-white shadow dark:bg-gray-900 dark:bg-gray-800 sm:rounded-lg">
          <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div
              class="border-t border-gray-200 p-6 dark:border-gray-700 dark:border-gray-700 md:border-t-0 md:border-l">
              <div class="flex items-center">
                <svg
                  fill="none"
                  stroke="currentColor"
            ...
            <div class="border-t border-gray-200 p-6 dark:border-gray-700 dark:border-gray-700">
              <div class="flex items-center">
                <svg
                  fill="none"
                  stroke="currentColor"
            ...
            <div class="border-t border-gray-200 p-6 dark:border-gray-700 dark:border-gray-700 md:border-l">
              <div class="flex items-center">
                <svg
                  fill="none"
                  stroke="currentColor"
              ...
              <div class="ml-12">
                <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  level. Pair them with powerful open source libraries like
