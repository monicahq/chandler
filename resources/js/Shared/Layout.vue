            ...
            <ul>
              <li class="inline mr-3">
                <inertia-link :href="layoutData.url.settings" class="inline">
                  <svg xmlns="http://www.w3.org/2000/svg" class="inline-block text-gray-600 h-4 w-4 sm:h-5 sm:w-5 cursor-pointer mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
