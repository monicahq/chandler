          ...
          <div class="flew-grow">
            <ul>
              <li class="inline mr-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="inline text-gray-600 h-4 w-4 sm:h-4 sm:w-4 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li class="inline">
                <svg @click="logout()" xmlns="http://www.w3.org/2000/svg" class="inline text-gray-600 h-4 w-4 sm:h-4 sm:w-4 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
