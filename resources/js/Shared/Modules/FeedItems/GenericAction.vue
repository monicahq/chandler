<template>
  <div
    ...
    class="flex items-center rounded-lg border border-gray-300 px-3 py-2 dark:border-gray-700">
    <avatar
      :data="data.avatar"
      :classes="'rounded-full border-gray-200 dark:border-gray-800 border relative h-8 w-8 ltr:mr-2 rtl:ml-2'" />
