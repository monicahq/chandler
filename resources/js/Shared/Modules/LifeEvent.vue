      ...
      <div v-if="localTimelines">
        <div v-for="timelineEvent in localTimelines" :key="timelineEvent.id" class="mb-4">
          ...
          <div
            ...
            <div>
              <span class="text-gray-500 ltr:mr-2 rtl:ml-2">{{ timelineEvent.happened_at }}</span>

              <span
                class="whitespace-nowrap rounded-lg bg-slate-100 px-2 py-0.5 text-sm text-slate-400 ltr:ml-3 rtl:mr-3 dark:bg-slate-900">
          ...
          <div v-if="!timelineEvent.collapsed">
            <div
              ...
              class="mb-2 rounded-lg border-gray-200 ltr:ml-6 rtl:mr-6 dark:border-gray-700">
              ...
              <template v-else>
                ...
                <div
                  ...
                  <div @click="toggleLifeEventVisibility(lifeEvent)" class="flex items-center">
                    <p v-if="lifeEvent.summary" class="text-sm font-bold ltr:mr-4 rtl:ml-4">{{ lifeEvent.summary }}</p>
                    <div>
                      <span
                ...
                <div
                  ...
                  <div class="flex items-center ltr:mr-4 rtl:ml-4">
                    <svg
                      ...
                      stroke-width="1.5"
                      stroke="currentColor"
                      class="h-4 w-4 text-gray-500 ltr:mr-2 rtl:ml-2">
                      <path
                        stroke-linecap="round"
                        stroke-linejoin="round"
                  ...
                  <div v-if="lifeEvent.distance" class="flex items-center">
                    <svg
                      class="h-6 w-6 text-gray-500 ltr:mr-2 rtl:ml-2"
                      viewBox="0 0 64 64"
                      xmlns="http://www.w3.org/2000/svg"
                      stroke-width="3"
                      stroke="#000000"
                ...
                <div v-if="!lifeEvent.collapsed" class="flex p-3 pb-1">
                  <div v-for="contact in lifeEvent.participants" :key="contact.id" class="ltr:mr-4 rtl:ml-4">
                    <contact-card
                      :contact="contact"
            ...
            <div class="mb-2 ltr:ml-6 rtl:mr-6">
              <span
