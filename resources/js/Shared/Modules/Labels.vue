  ...
  <div class="mb-4">
    ...
    <div
      ...
      <ul class="label-list overflow-auto bg-white dark:bg-gray-900" :class="filteredLabels.length > 0 ? 'h-40' : ''">
        <li
          ...
          @click="set(label)">
          <div>
            <span class="inline-block h-4 w-4 rounded-full ltr:mr-2 rtl:ml-2" :class="label.bg_color" />
    ...
    <div class="flex flex-wrap">
      <span
        ...
        :key="label.id"
        class="mb-2 inline-block rounded px-2 py-1 text-xs font-semibold last:mr-0 ltr:mr-2 rtl:ml-2"
