...
{
    public function store(Request $request, int $vaultId, string $contactId, int $timelineEventId)
    {
    ...
    public function destroy(Request $request, int $vaultId, string $contactId, int $timelineEventId, int $lifeEventId)
    {
        $data = [
            'account_id' => Auth::user()->account_id,
            'author_id' => Auth::id(),
