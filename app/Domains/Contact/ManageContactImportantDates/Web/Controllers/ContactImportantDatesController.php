...
class ContactImportantDatesController extends Controller
{
    ...
    public function update(Request $request, int $vaultId, string $contactId, int $dateId)
    {
        $day = '';
        $month = '';
        $year = '';
    ...
    public function destroy(Request $request, int $vaultId, string $contactId, int $dateId)
    {
        $data = [
            'account_id' => Auth::user()->account_id,
            'author_id' => Auth::id(),
