...
class ContactModuleGroupController extends Controller
{
     ...
     * with it.
     */
    public function store(Request $request, int $vaultId, string $contactId): JsonResponse
    {
    ...
    public function destroy(Request $request, int $vaultId, string $contactId, int $groupId)
    {
        $data = [
            'account_id' => Auth::user()->account_id,
            'author_id' => Auth::id(),
