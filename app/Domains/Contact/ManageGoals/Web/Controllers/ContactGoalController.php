...
{
    public function show(Request $request, int $vaultId, string $contactId, int $goalId)
    {
    ...
    public function update(Request $request, int $vaultId, string $contactId, int $goalId)
    {
        $data = [
    ...
    public function destroy(Request $request, int $vaultId, string $contactId, int $goalId)
    {
        $data = [
            'account_id' => Auth::user()->account_id,
            'author_id' => Auth::id(),
