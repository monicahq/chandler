...
class ContactModulePetController extends Controller
{
    ...
    public function update(Request $request, int $vaultId, string $contactId, int $petId)
    {
        $data = [
            'account_id' => Auth::user()->account_id,
            'author_id' => Auth::id(),
    ...
    public function destroy(Request $request, int $vaultId, string $contactId, int $petId)
    {
        $data = [
            'account_id' => Auth::user()->account_id,
            'author_id' => Auth::id(),
