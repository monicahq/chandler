...
{
    public function show(Request $request, int $vaultId, string $contactId, int $templateId): JsonResponse
    {
    ...
    public function store(Request $request, int $vaultId, string $contactId, int $templateId): JsonResponse
    {
        $data = [
    ...
    public function update(Request $request, int $vaultId, string $contactId, int $templateId, int $quickFactId): JsonResponse
    {
        $data = [
            'account_id' => Auth::user()->account_id,
            'author_id' => Auth::id(),
    ...
    public function destroy(Request $request, int $vaultId, string $contactId, int $templateId, int $quickFactId)
    {
        $data = [
            'account_id' => Auth::user()->account_id,
            'author_id' => Auth::id(),
