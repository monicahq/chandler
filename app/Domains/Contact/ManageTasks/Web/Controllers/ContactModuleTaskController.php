...
class ContactModuleTaskController extends Controller
{
    ...
    public function store(Request $request, int $vaultId, string $contactId)
    {
        $dueAt = '';
    ...
    public function update(Request $request, int $vaultId, string $contactId, int $taskId)
    {
        $dueAt = '';
    ...
    public function toggle(Request $request, int $vaultId, string $contactId, int $taskId)
    {
        $data = [
            'account_id' => Auth::user()->account_id,
            'author_id' => Auth::id(),
    ...
    public function destroy(Request $request, int $vaultId, string $contactId, int $taskId)
    {
        $data = [
            'account_id' => Auth::user()->account_id,
            'author_id' => Auth::id(),
