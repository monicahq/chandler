...
{
    public function create(Request $request, int $vaultId, string $contactId)
    {
    ...
    public function update(Request $request, int $vaultId, string $contactId, int $relationshipId)
    {
