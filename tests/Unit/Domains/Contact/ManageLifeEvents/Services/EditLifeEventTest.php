...
class EditLifeEventTest extends TestCase
{
    use DatabaseTransactions;

    /** @test */
    public function it_edits_a_life_event(): void
    {
        ...
        $this->executeService($user, $user->account, $vault, $contact, $lifeEventType, $timelineEvent, $lifeEvent);
    }
    ...
    public function it_fails_if_wrong_parameters_are_given(): void
    {
        ...
        (new EditLifeEvent())->execute($request);
    }
    ...
    public function it_fails_if_user_doesnt_belong_to_account(): void
    {
        ...
        $this->executeService($user, $account, $vault, $contact, $lifeEventType, $timelineEvent, $lifeEvent);
    }
    ...
    /** @test */
    public function it_fails_if_life_event_doesnt_belong_to_account(): void
    {
        $this->expectException(ModelNotFoundException::class);
    ...
    private function executeService(User $author, Account $account, Vault $vault, Contact $contact, LifeEventType $lifeEventType, TimelineEvent $timelineEvent, LifeEvent $lifeEvent): void
    {
        $request = [
        ...
        $lifeEvent = (new EditLifeEvent())->execute($request);
