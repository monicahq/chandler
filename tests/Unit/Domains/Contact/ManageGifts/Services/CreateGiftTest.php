...
class CreateGiftTest extends TestCase
{
    ...
    public function it_creates_a_gift(): void
    {
        ...
        $this->executeService($regis, $regis->account, $vault, $contact, $donator, $recipient);
    }
    ...
    public function it_fails_if_user_doesnt_belong_to_account(): void
    {
        ...
        $this->executeService($regis, $account, $vault, $contact, $donator, $recipient);
    }
    ...
    private function executeService(User $author, Account $account, Vault $vault, Contact $contact, Contact $donator, Contact $recipient): void
    {
