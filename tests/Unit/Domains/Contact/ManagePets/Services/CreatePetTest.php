...
class CreatePetTest extends TestCase
{
    ...
    public function it_creates_a_pet(): void
    {
        ...
        $this->executeService($regis, $regis->account, $vault, $contact, $petCategory);
    }
    ...
    public function it_fails_if_user_doesnt_belong_to_account(): void
    {
        ...
        $this->executeService($regis, $account, $vault, $contact, $petCategory);
    }
    ...
    private function executeService(User $author, Account $account, Vault $vault, Contact $contact, PetCategory $petCategory): void
    {
        $request = [
