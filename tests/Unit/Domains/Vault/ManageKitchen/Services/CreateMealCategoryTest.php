...
class CreateMealCategoryTest extends TestCase
{
    use DatabaseTransactions;

    /** @test */
    public function it_creates_a_meal_category(): void
    {
    ...
    public function it_fails_if_wrong_parameters_are_given(): void
    {
        ...
        (new CreateMealCategory())->execute($request);
    }
    ...
    private function executeService(User $author, Account $account, Vault $vault): void
    {
        ...
        $mealCategory = (new CreateMealCategory())->execute($request);
