...
use App\Domains\Vault\ManageKitchen\Services\RemoveIngredientFromMeal;
...
class RemoveIngredientFromMealTest extends TestCase
{
    use DatabaseTransactions;

    /** @test */
    public function it_removes_an_ingredient_from_a_meal(): void
    {
        ...
        $meal->ingredients()->syncWithoutDetaching($ingredient);
    ...
    public function it_fails_if_wrong_parameters_are_given(): void
    {
        ...
        (new RemoveIngredientFromMeal())->execute($request);
    }
